    ...
    private void animateExitSettings() {
        ...
        settingsAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                float value = (float) animation.getAnimatedValue();
                contentContainer2.setTranslationY(value);
...
//refreshBackground();
    ...
    private void s_hide() {
        ...
        // Schedule a runnable to remove the status and navigation bar after a delay
        contentContainer2 = (ScrollView) findViewById(R.id.contentContainer2);
        /*
        contentContainer2.setSystemUiVisibility(View.SYSTEM_UI_FLAG_LOW_PROFILE
